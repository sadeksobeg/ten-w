...
export default async function AdminCreatorsPage({ params }: Props) {
  ...
  const partners: CreatorAdminPartner[] = allPartners.map((u) => ({
    ...
    consentUserAgent: u.creatorArenaProfile?.consentUserAgent ?? null,
    consentLocale: u.creatorArenaProfile?.consentLocale ?? null,
    consentTextHash: u.creatorArenaProfile?.consentTextHash ?? null,
