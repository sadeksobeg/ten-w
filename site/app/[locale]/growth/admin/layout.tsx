...
export default async function GrowthAdminLayout({ children, params }: Props) {
  ...
  return (
    <div className="space-y-6 sm:space-y-10">
      <div className="sticky top-14 z-[60] -mx-4 mb-2 flex flex-col gap-3 border-b border-white/10 bg-[#050816]/95 px-4 py-3 backdrop-blur-lg sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 lg:flex-row lg:items-start lg:justify-between">
