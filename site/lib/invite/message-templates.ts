...
export const INVITE_MESSAGE_TEMPLATES: Record<InviteTier, string> = {
  "CONTENT CREATOR":
    "يسعدنا دعوتك للانضمام إلى TENEGTA ASCEND — برنامجنا الحصري لصنّاع المحتوى. نتطلع إلى استكشاف إمكانيات التعاون معك، ومناقشة الرؤى المشتركة، وبناء شراكة إبداعية مستدامة. تفضل بقبول دعوتك الرقمية لتفعيل بطاقتك والانضمام رسمياً.",
  "SERVICE PARTNER":
...
export const INVITE_MESSAGE_AFTER_MEETING =
  "بعد لقائنا المُثمر واتفاقنا على التعاون، يسعدنا أن نقدّم لك بطاقة دخولك الرسمية إلى TENEGTA ASCEND. هذه خطوتك التالية لتفعيل حضورك رسمياً، واستكشاف ما ينتظرك من مشاريع وشراكات نوعية في المرحلة القادمة. نحن متحمّسون للانطلاق معك. مع خالص التقدير";
