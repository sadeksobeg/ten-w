...
Tout reste dans le réseau banque.`,
    ...
    clientQuote: {
      ...
      org: { ar: "مؤسسة مالية إقليمية", en: "Regional financial institution", fr: "Institution financière régionale" },
      initials: "OP",
    },
  },
  {
...
• Conformité — chiffrement, consentements, audit`,
    ...
    clientQuote: {
      ...
      org: { ar: "شبكة عيادات خاصة", en: "Private clinic network", fr: "Réseau cliniques privées" },
      initials: "MD",
    },
  },
];
