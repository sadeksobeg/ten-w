...
async function main() {
  ...
  const badgeDefs: Array<{
    ...
    },
    {
      ...
      criteria: { kind: "admin_grant_only" },
    },
    {
    ...
    },
    {
      ...
      type: BadgeType.AUTO,
      category: BadgeCategory.SOCIAL,
      description: "10 partners in your network.",
      criteria: { kind: "min_downlines", value: 10 },
    },
    {
      key: "streak_7",
    ...
    },
    {
      ...
      type: BadgeType.AUTO,
      category: BadgeCategory.FINANCIAL,
      description: "$1,000+ commissions earned.",
      criteria: { kind: "commission_cents", value: 100_000 },
    },
    {
      key: "events_5",
      name: "Event Pro",
      type: BadgeType.AUTO,
      category: BadgeCategory.SOCIAL,
      description: "Joined 5 events.",
      criteria: { kind: "event_joins", value: 5 },
    },
    {
      key: "speed_demon",
      name: "Speed Demon",
      type: BadgeType.AUTO,
      category: BadgeCategory.BEHAVIORAL,
      description: "Closed a deal in under 12 hours.",
      criteria: { kind: "fast_close_hours", value: 12 },
    },
    {
      key: "perfect_week",
      name: "Perfect Week",
    ...
    },
    {
      ...
      category: BadgeCategory.BEHAVIORAL,
      hidden: true,
      description: "Returned after a long absence.",
      criteria: { kind: "hidden_manual" },
    },
    {
      key: "beta_tester",
    ...
    },
    {
      ...
      type: BadgeType.ADMIN,
      category: BadgeCategory.META,
      description: "Top partner of the quarter.",
      criteria: { kind: "admin_grant_only" },
    },
    {
      key: "referral_chain",
      ...
      type: BadgeType.AUTO,
      category: BadgeCategory.SOCIAL,
      description: "2-level deep network.",
      criteria: { kind: "network_depth", value: 2 },
    },
    {
      key: "appreciation_received",
      name: "Appreciated",
      type: BadgeType.AUTO,
      category: BadgeCategory.SOCIAL,
      description: "5 profile appreciations received.",
      criteria: { kind: "appreciation_count", value: 5 },
    },
  ];
